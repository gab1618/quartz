...
fn add_header_to_env() {
    let test_quartz = TestQuartz::empty().unwrap();
    test_quartz.inner.header_set("Header1: value1").unwrap();
    test_quartz.inner.header_set("Header2: value2").unwrap();

    let found_header = test_quartz.inner.header_get("Header1").unwrap();
    assert_eq!(found_header, "value1".to_owned());

    test_quartz.inner.create_env("dev").unwrap();
    test_quartz.inner.switch_env("dev").unwrap();
    test_quartz.inner.header_get("Header1").unwrap_err();
    test_quartz.inner.switch_env("default").unwrap();

    test_quartz.inner.header_rm("Header1").unwrap();
    test_quartz.inner.header_get("Header1").unwrap_err();
}
...
fn copy_env() {
    ...
    test_quartz.inner.header_set("Header1: value1").unwrap();
    let retrieved_header = test_quartz.inner.header_get("Header1").unwrap();
    ...
    let cloned_header = test_quartz.inner.header_get("Header1").unwrap();
